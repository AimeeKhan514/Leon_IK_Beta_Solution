...
<body>
    ...
    <div class="container">
        ...
        <div class="col-12 mb-4">
            <p class="text-secondary fs-4 mb-5">Since 2008, we have been privileged to partner with many national (from
                Auckland to Christchurch) and international businesses and entrepreneurs. In the process, we have
                undertaken hundreds of technical projects and brought dozens of leading electronic products to market.
            </p>
            <p class="text-secondary fs-4 mb-5">Specialising in the high-tech electronic and electro-mechanical sector,
                we believe in empowering our clients with innovative solutions and technology to help make a positive
            ...
            <p class="text-secondary fs-4 mb-5">Beta Solutions is an Approved Research Provider for the R&D Tax
                Incentive in New Zealand in seven different areas of research expertise. Contact us today to find out
                more.</p>
        </div>
        <div class="col-12 mb-4">
            ...
            <div class="col-lg-6 py-lg-5 p-3">
                ...
                <div class="col-lg-10 mb-4">
                    <p class="text-secondary fs-3">
                        ...
                        <span><span class="fas fa-circle" style="font-size: 2px;"></span> Excellence</span> <span><span
                                class="fas fa-circle" style="font-size: 2px;"></span> Innovation</span>
                        <span><span class="fas fa-circle" style="font-size: 2px;"></span> Enjoyment</span>
                </div>
                <div class="col-12 pt-5 mb-4">
                    <a href="contact" class="btn-lg btn-success-custom text-decoration-none py-3 px-5">Learn About Our
                        Values</a>
                </div>
            </div>
            <div class="col-lg-6">
