...
<h3 class = "card-title float-left text-uppercase font-weight-bold">Page Name
</h3>
<a href = "manage-page-name" class = "card-title float-right btn btn-primary">Add
Page Name
</a>
</div>
...
?>
        ...
        <td><?php echo $row["id"];
        ?></td>
        <td title="<?php echo ucwords(str_replace("-"," ",$row["name"]));
        ?>" rel="tooltip"><?php echo ucwords(str_replace("-"," ",$row["name"]));
        ?></td>
        ...
        ?></td>
        <td>
        <a href = "manage-page-name?id=<?php echo $row['id'] ?>"
