                ...
                <div class="col-12 px-0">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h3 class="card-title float-left text-uppercase font-weight-bold">color
                            </h3>
                            <a href="manage-color" class="card-title float-right btn btn-primary">Add color
                            </a>
                        </div>
...
?>
                                    ...
                                    <td><?php echo $serial;?></td>
                                        ...
                                        <td title="<?php echo $row["color"];?>" rel="tooltip">
                                        <div class="col-12 p-3" style="max-width: 150px;background-color:<?php echo $row["color"];?>;"></div></td>
                                        ...
                                        <td>
                                            <a href="manage-color?id=<?php echo $row['id'] ?>" class="btn btn-success btn-sm text-white" rel="tooltip" title="Edit"><i class="material-icons">create</i></a>
