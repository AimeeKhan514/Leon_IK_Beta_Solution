...
<h3 class = "card-title float-left text-uppercase font-weight-bold">teams
</h3>
<a href = "manage-teams" class = "card-title float-right btn btn-primary">Add New
</a>
</div>
...
?>
        ...
        <td><?php echo $row["id"];
        ?></td>
        <td><img src = "../assets/media/teams/<?php echo $row["image"]; ?>"
        ...
        ?></td>
        <td>
        <a href = "manage-teams?id=<?php echo $row['id'] ?>"
