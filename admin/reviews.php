...
<h3 class = "card-title float-left text-uppercase font-weight-bold">reviews
</h3>
<a href = "manage-reviews" class = "card-title float-right btn btn-primary">Add
New
</a>
</div>
...
?>
        ...
        <td title = "<?php if($row["rating"]!=""){ echo $row["rating"]." Stars";}else{ echo "Empty";}?>" rel = "tooltip" class = "  text-truncate btn-tooltip" tab-index="0"
        style = "max-width: 150px;"><?php if($row["rating"]!=""){ echo $row["rating"]." Stars";}else{ echo "Empty";}?></td>

        <td title = "<?php if($row["duration"]!=""){ echo $row["duration"];}else{ echo "Empty";}?>" rel = "tooltip" class = "  text-truncate btn-tooltip" tab-index="0"
        style = "max-width: 150px;"><?php if($row["duration"]!=""){ echo $row["duration"];}else{ echo "Empty";}?></td>
        ...
        ?></td>
        <td>
        <a href = "manage-reviews?id=<?php echo $row['id'] ?>"
