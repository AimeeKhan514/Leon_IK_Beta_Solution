...
<h3 class = "card-title float-left text-uppercase font-weight-bold">projects
</h3>
<a href = "manage-projects" class = "card-title float-right btn btn-primary">Add
New
</a>
</div>
...
?>
        ...
        <td title = "<?php if($row["tag"]!=""){ echo $row["tag"];}else{ echo "Empty";}?>" rel = "tooltip" class = "  text-truncate btn-tooltip" tab-index="0"
        style = "max-width: 150px;"><?php if($row["tag"]!=""){ echo $row["tag"];}else{ echo "Empty";}?></td>

        <td><img src = "../assets/media/projects/<?php echo $row["image"]; ?>"
        ...
        ?></td>
        <td>
        <a href = "manage-projects?id=<?php echo $row['id'] ?>"
