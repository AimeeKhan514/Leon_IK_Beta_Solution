...
<h3 class = "card-title float-left text-uppercase font-weight-bold">Engineering Consultancy
</h3>
<a href = "manage-engineering-consultancy" class = "card-title float-right btn btn-primary">Add
New
</a>
</div>
...
?>
        ...
        <td><img src = "../assets/media/engineering-consultancy/<?php echo $row["image"]; ?>"
        ...
        ?></td>
        <td>
        <a href = "manage-engineering-consultancy?id=<?php echo $row['id'] ?>"
