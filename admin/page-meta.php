...
<h3 class = "card-title float-left text-uppercase font-weight-bold">Page Meta</h3>
<a href = "manage-page-meta" class = "card-title float-right btn btn-primary">Add Meta</a>
</div>
...
?>
        ...
        <td><?php echo $row["id"];
        ?></td>
         <td title="<?php echo $row["page_name"]; ?>" rel="tooltip"><span class = "d-inline-block text-truncate"
        style = "max-width: 150px;"><?php echo ucfirst(str_replace( "-", " ", $row["page_name"] ));
        ?></span>
        </td>
        <td title="<?php echo $row["meta_title"]; ?>" rel="tooltip"><span class = "d-inline-block text-truncate"
        style = "max-width: 150px;"><?php echo $row["meta_title"];
        ?></span>
        </td>
        <td title="<?php echo $row["meta_desc"]; ?>" rel="tooltip"><span class = "d-inline-block text-truncate"
        style = "max-width: 150px;"><?php echo $row["meta_desc"];
        ?></span>
        </td>
        <td title="<?php echo $row["meta_keyword"]; ?>" rel="tooltip"><span class = "d-inline-block text-truncate"
        style = "max-width: 150px;"><?php echo $row["meta_keyword"];
        ?></span>
        </td>
        ...
        ?></td>
        <td>
        <a href = "manage-page-meta?id=<?php echo $row['id'] ?>"
