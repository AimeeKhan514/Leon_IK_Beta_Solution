                ...
                <div class="col-12 px-0">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h3 class="card-title float-left text-uppercase font-weight-bold">Size
                            </h3>
                            <a href="manage-size" class="card-title float-right btn btn-primary">Add Size
                            </a>
                        </div>
...
?>
                                    ...
                                    <td><?php echo $serial;?></td>
                                        ...
                                        <td title="<?php echo $row["size"];?>" rel="tooltip"><span class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo $row["size"];?></span></td>
                                        <td title="<?php echo $row["order_by"];?>" rel="tooltip"><span class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo $row["order_by"];?></span></td>
                                        ...
                                        <td>
                                            <a href="manage-size?id=<?php echo $row['id'] ?>" class="btn btn-success btn-sm text-white" rel="tooltip" title="Edit"><i class="material-icons">create</i></a>
