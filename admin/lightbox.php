...
<h3 class = "card-title float-left text-uppercase font-weight-bold">lightbox
</h3>
<a href = "manage-lightbox" class = "card-title float-right btn btn-primary">Add
lightbox
</a>
</div>
...
?>
        ...
        <td><img src = "../media/lightbox/<?php echo $row["image"]; ?>"
        ...
        ?></td>
        <td>
        <a href = "manage-lightbox?id=<?php echo $row['id'] ?>"
...
require_once("../inc/pagination.php");
    ...
    echo '<div class="btn btn-lg w-100 btn-primary bg-gradient-primary text-white"> <strong>SORRY! </strong> No Data Found </div>';
}
 ?>
</div>
</div>
