...
<h3 class = "card-title float-left text-uppercase font-weight-bold">slider
</h3>
<a href = "manage-slider" class = "card-title float-right btn btn-primary">Add
slider
</a>
</div>
...
?>
        ...
        <td title = "<?php if($row["tagline"]!=""){ echo $row["tagline"];}else{ echo "Empty";}?>" rel = "tooltip"><?php if($row["tagline"]!=""){ echo $row["tagline"];}else{ echo "Empty";}?></td>
         ...
         <td title = "<?php if(!empty($row["link"])){echo str_replace("-"," ",$row["link"]);}else{echo "Nil";} ?>" rel = "tooltip"><a href="<?php if(!empty($row["link"])){echo str_replace("-"," ",$row["link"]);}else{echo "javascript:void(0);";} ?>" target="_blank"><?php if(!empty($row["link"])){echo str_replace("-"," ",$row["link"]);}else{echo "Nil";} ?></a></td>
         
         <td title = "<?php if($row["linktitle"]==""){echo "Not Set";}else{ echo $row["linktitle"];} ?>" rel = "tooltip"><?php if($row["linktitle"]==""){echo "Empty..!";}else{ echo $row["linktitle"];} ?></td>
         
        <td><img src = "../media/slider/<?php echo $row["image"]; ?>"
        ...
        ?></td>
        <td>
        <a href = "manage-slider?id=<?php echo $row['id'] ?>"
