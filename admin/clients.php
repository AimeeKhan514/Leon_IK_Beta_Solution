...
<h3 class = "card-title float-left text-uppercase font-weight-bold">clients
</h3>
<a href = "manage-clients" class = "card-title float-right btn btn-primary">Add New
</a>
</div>
...
?>
        ...
        <td><?php echo $row["id"];
        ?></td>
        <td><img src = "../assets/media/clients/<?php echo $row["image"]; ?>"
        ...
        ?></td>
        <td>
        <a href = "manage-clients?id=<?php echo $row['id'] ?>"
