...
if ( isset( $_POST["submit"] ) ) {
    ...
    if ( empty( $_FILES["image"]["name"] ) ) {
        $image = $_POST["old_image"];
         ...
         unlink('../assets/media/engineering-consultancy/' . $image);
        $image = $_FILES["image"]["name"];
        $image = rand( 111111111, 999999999 ) . "_" . $image;
        move_uploaded_file( $_FILES["image"]["tmp_name"], '../assets/media/engineering-consultancy/' . $image );
    }
    ...
    header( "location:engineering-consultancy" );
    die();
}
?>
<div class="wrapper">
...
?> Engineering Consultancy</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-6 p-3">
                                        ...
                                        <input type="text" id="title" name="title" value="<?php echo $title; ?>"
                                            class="form-control" placeholder="Concept to Commercialisation" autofocus>
                                    </div>
                                    <div class="col-md-6 p-3">
                                    ...
                                    <div class="col-md-12 p-3">
                                        ...
                                        <textarea id="description" name="description" class="form-control"
                                            placeholder="Turning new product ideas into reality or ageing products..."><?php echo $description;?></textarea>
                                    </div>
                                </div>
                        </div>
                        <div class="col-12 p-3">
                            <div class="row">
                                ...
                                <div class="col-md-2 px-2"> <a href="./engineering-consultancy"
