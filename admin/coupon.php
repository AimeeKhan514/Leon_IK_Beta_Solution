                ...
                <div class="col-12 px-0">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h3 class="card-title float-left text-uppercase font-weight-bold">coupon
                            </h3>
                            <a href="manage-coupon" class="card-title float-right btn btn-primary">Add coupon
                            </a>
                        </div>
...
?>
                                    ...
                                    <td><?php echo $serial;?></td>
                                        ...
                                        <td title="<?php echo $row["coupon_code"];?>" rel="tooltip"><span class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo $row["coupon_code"];?></span></td>

                                        <td title="<?php echo $row["price"];?>" rel="tooltip"><span class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo $row["price"];?></span></td>
                                        ...
                                        <td>
                                            <a href="manage-coupon?id=<?php echo $row['id'] ?>" class="btn btn-success btn-sm text-white" rel="tooltip" title="Edit"><i class="material-icons">create</i></a>
